...
"use strict";angular.module("travelPlanningGame.settings",[]),angular.module("travelPlanningGame.maps",["AngularGM","travelPlanningGame.templates"]),angular.module("travelPlanningGame.widgets",["AngularGM","travelPlanningGame.templates"]),angular.module("travelPlanningGame.app",["ngCookies","ngResource","ngSanitize","ngRoute","ui.bootstrap","angular-underscore","angular-rome2rio","travelPlanningGame.settings","travelPlanningGame.maps","travelPlanningGame.widgets","travelPlanningGame.templates"]).config(["$routeProvider","rome2rioProvider",function(a,b){a.when("/start",{templateUrl:"views/start.html",controller:"StartCtrl"}).when("/play",{templateUrl:"views/play.html",controller:"PlayCtrl"}).when("/end",{templateUrl:"views/end.html",controller:"EndCtrl"}).otherwise({redirectTo:"/start"}),b.setKey("uuSKZSEU"),b.setServer("free.rome2rio.com"),b.setResponseFormat("json"),b.setAPIVersion("1.2"),b.setCurrency("AUD"),b.setDetailLevel("street_address")}]),angular.module("travelPlanningGame.app").factory("bankingAccounts",function(){var a=function(a){this.balance={},this.balance.initial=0+a,this.balance.current=0+a,this.balance.history={},this._canWithdraw=function(a){return a<=this.balance.current},this._recordSnapshot=function(a,b){return a||(a=(new Date).getTime()),angular.isDefined(this.balance.history[a])?!1:(this.balance.history[a]={openingBalance:this.balance.current,closingBalance:this.balance.current+b},!0)},this.transactions={};var b=function(a,b){this.credit=0+a,this.description=b};this._makeTransaction=function(a,c,d){var e=new b(a,c);return d||(d=(new Date).getTime()),angular.isDefined(this.transactions[d])?!1:this._recordSnapshot(d,a)?(this.transactions[d]=e,this.balance.current+=a,!0):!1},this.credit=function(a,b,c){return a>0?this._makeTransaction(a,b,c):!1},this.debit=function(a,b,c){return a>0&&this._canWithdraw(a)?this._makeTransaction(-1*a,b,c):!1},this.getSnapshot=function(a){return a?this.balance.history[a]:null},this.getTransaction=function(a){return a?this.transactions[a]:null}},b={};return this.createAccount=function(c,d){if(d||(d=0),c){var e=new a(d);return b[c]=e,e}return null},this.getAccount=function(a){return a?b[a]:null},this}).factory("bankingManager",["bankingAccounts",function(a){var b={};b.GENERAL=10,b.ONETIME=20,b.VISITING=30,b.LODGING=40,b.SHOPPING=50,b.RANDOM=60,b.OTHER=70;var c={};c.GENERAL=10,c.MONEY=20,c.XP=30,c.SOUVENIR=40,c.OTHER=50;var d=function(d){this.types=c,this.categories=b,a.createAccount(this.types.MONEY,d),a.createAccount(this.types.XP),a.createAccount(this.types.SOUVENIR),this._categorizedTimestamp={},this._categorizedTimestamp._delimiter="##",this._categorizedTimestamp.marshal=function(a,b){var c=this._delimiter;return a+c+b},this._categorizedTimestamp.unmarshal=function(a){var b=this._delimiter,c=a.split(b);return 2!==c.length?null:{timestamp:c[0],category:c[1]}},this.addExpense=function(b,c,d,e){if(!c||!d||!b)return!1;e||(e=(new Date).getTime());var f=this._categorizedTimestamp.marshal(e,d);return a.getAccount(c).debit(b,d,f)},this.addGain=function(b,c,d,e){if(!c||!d||!b)return!1;e||(e=(new Date).getTime());var f=this._categorizedTimestamp.marshal(e,d);return a.getAccount(c).credit(b,d,f)},this.get=function(b){return a.getAccount(b).balance.current},this.getBudget=function(){return this.get(this.types.MONEY)},this.getXP=function(){return this.get(this.types.XP)},this.getSouvenirs=function(){return this.get(this.types.SOUVENIR)},this.getActivity=function(b){var c={};return angular.forEach(this.types,function(d){c[d]={};var e=a.getAccount(d);e&&angular.forEach(this.categories,function(e){var f=this._categorizedTimestamp.marshal(b,e);c[d][e]=a.getAccount(d).getTransaction(f)},this)},this),c}},e={};return this.manage=function(a,b){if(a){if(e[a])return e[a];var c=new d(b);return e[a]=c,c}return null},this.types=c,this.categories=b,this}]),angular.module("travelPlanningGame.app").factory("days",["$filter","bankingManager",function(a,b){function c(b){var c=a("find")(d,function(c){return a("find")(c.landmarksVisited,function(a){return a.id===b.id})});return angular.isDefined(c)}var d=[],e={};return e.getAllDays=function(){return d},e.getDay=function(a){return d[a]},e.newDay=function(a){var e={};return e.finances=a,e.landmarksVisited=[],e.toTimestamp=function(){return"day"+d.length},e.addLandmark=function(a){return this.landmarksVisited.push(a),c(a)||this.finances.addGain(a.exp,b.types.XP,b.categories.ONETIME,this.toTimestamp()),this.finances.addGain(a.visitingExp,b.types.XP,b.categories.VISITING,this.toTimestamp()),this.finances.addExpense(a.visitingCost,b.types.MONEY,b.categories.VISITING,this.toTimestamp()),this.finances.addExpense(a.lodgingCost,b.types.MONEY,b.categories.LODGING,this.toTimestamp()),this},e.addShopping=function(a,c){return this.finances.addExpense(c,b.types.MONEY,b.categories.SHOPPING,this.toTimestamp()),this.finances.addGain(a,b.types.SOUVENIR,b.categories.SHOPPING,this.toTimestamp()),this},e.end=function(){return d.push(this),e},e.skip=function(a){var c=a-1;if(c>=0){var f=d[c].landmarksVisited,g=f[f.length-1];this.finances.addExpense(g.lodgingCost,b.types.MONEY,b.categories.LODGING,this.toTimestamp())}return d.push(this),e},e},e}]),angular.module("travelPlanningGame.app").factory("landmarks",["$http","$q",function(a,b){function c(){var c=b.defer();return d?c.resolve():a.get("landmarks.json").success(function(a){d=a,c.resolve()}).error(function(){d=[],c.reject()}),c.promise}var d=null;return{get:c}}]),angular.module("travelPlanningGame.maps").factory("mapGeocoder",["$q","angulargmUtils",function(a,b){var c=new google.maps.Geocoder,d={};return d.toCoords=function(d){var e=a.defer();return c.geocode({address:d},function(a){e.resolve(b.latLngToObj(a[0].geometry.location))}),e.promise},d.toAddress=function(b){var d=a.defer();return c.geocode({latLng:b},function(a){d.resolve(a[0].formatted_address)}),d.promise},d}]),angular.module("travelPlanningGame.maps").factory("mapStyles",function(){var a={};return a.shiftWorker=[{stylers:[{saturation:-100},{gamma:1}]},{elementType:"labels.text.stroke",stylers:[{visibility:"off"}]},{featureType:"poi.business",elementType:"labels.text",stylers:[{visibility:"off"}]},{featureType:"poi.business",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"poi.place_of_worship",elementType:"labels.text",stylers:[{visibility:"off"}]},{featureType:"poi.place_of_worship",elementType:"labels.icon",stylers:[{visibility:"off"}]},{featureType:"road",elementType:"geometry",stylers:[{visibility:"simplified"}]},{featureType:"water",stylers:[{visibility:"on"},{saturation:50},{gamma:0},{hue:"#50a5d1"}]},{featureType:"administrative.neighborhood",elementType:"labels.text.fill",stylers:[{color:"#333333"}]},{featureType:"road.local",elementType:"labels.text",stylers:[{weight:.5},{color:"#333333"}]},{featureType:"transit.station",elementType:"labels.icon",stylers:[{gamma:1},{saturation:50}]}],a.routeXL=[{featureType:"administrative",elementType:"all",stylers:[{visibility:"on"},{saturation:-100},{lightness:20}]},{featureType:"road",elementType:"all",stylers:[{visibility:"on"},{saturation:-100},{lightness:40}]},{featureType:"water",elementType:"all",stylers:[{visibility:"on"},{saturation:-10},{lightness:30}]},{featureType:"landscape.man_made",elementType:"all",stylers:[{visibility:"simplified"},{saturation:-60},{lightness:10}]},{featureType:"landscape.natural",elementType:"all",stylers:[{visibility:"simplified"},{saturation:-60},{lightness:60}]},{featureType:"poi",elementType:"all",stylers:[{visibility:"off"},{saturation:-100},{lightness:60}]},{featureType:"transit",elementType:"all",stylers:[{visibility:"off"},{saturation:-100},{lightness:60}]}],a.paleDawn=[{featureType:"water",stylers:[{visibility:"on"},{color:"#acbcc9"}]},{featureType:"landscape",stylers:[{color:"#f2e5d4"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#c5c6c6"}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#e4d7c6"}]},{featureType:"road.local",elementType:"geometry",stylers:[{color:"#fbfaf7"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#c5dac6"}]},{featureType:"administrative",stylers:[{visibility:"on"},{lightness:33}]},{featureType:"road"},{featureType:"poi.park",elementType:"labels",stylers:[{visibility:"on"},{lightness:20}]},{},{featureType:"road",stylers:[{lightness:20}]}],a.oldTimey=[{featureType:"administrative",stylers:[{visibility:"off"}]},{featureType:"poi",stylers:[{visibility:"simplified"}]},{featureType:"road",stylers:[{visibility:"simplified"}]},{featureType:"water",stylers:[{visibility:"simplified"}]},{featureType:"transit",stylers:[{visibility:"simplified"}]},{featureType:"landscape",stylers:[{visibility:"simplified"}]},{featureType:"road.highway",stylers:[{visibility:"off"}]},{featureType:"road.local",stylers:[{visibility:"on"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{visibility:"on"}]},{featureType:"water",stylers:[{color:"#84afa3"},{lightness:52}]},{stylers:[{saturation:-77}]},{featureType:"road"}],a.midnight=[{featureType:"water",stylers:[{color:"#021019"}]},{featureType:"landscape",stylers:[{color:"#08304b"}]},{featureType:"poi",elementType:"geometry",stylers:[{color:"#0c4152"},{lightness:5}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#000000"}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{color:"#0b434f"},{lightness:25}]},{featureType:"road.arterial",elementType:"geometry.fill",stylers:[{color:"#000000"}]},{featureType:"road.arterial",elementType:"geometry.stroke",stylers:[{color:"#0b3d51"},{lightness:16}]},{featureType:"road.local",elementType:"geometry",stylers:[{color:"#000000"}]},{elementType:"labels.text.fill",stylers:[{color:"#ffffff"}]},{elementType:"labels.text.stroke",stylers:[{color:"#000000"},{lightness:13}]},{featureType:"transit",stylers:[{color:"#146474"}]},{featureType:"administrative",elementType:"geometry.fill",stylers:[{color:"#000000"}]},{featureType:"administrative",elementType:"geometry.stroke",stylers:[{color:"#144b53"},{lightness:14},{weight:1.4}]}],a}),angular.module("travelPlanningGame.settings").factory("gameSettings",function(){var a={};a.finances={},a.finances.budget=5e3,a.finances.upgradesAvailable={},a.finances.upgradesAvailable.travelCard=!1,a.locations=[{city:"Singapore",country:"Singapore",enabled:!0},{city:"Tokyo",country:"Japan",enabled:!1},{city:"Melbourne",country:"Australia",enabled:!1}],a.selectedLocation=0,a.daysOfTravel=3,a.sandboxMode=!1;var b={};return b.getSettings=function(){return a},b}),angular.module("travelPlanningGame.settings").factory("userSettings",function(){var a=42;return{someMethod:function(){return a}}}),angular.module("travelPlanningGame.app").directive("collapsibleColumns",function(){return{restrict:"EA",transclude:!0,template:'<div class="collapsible-columns" ng-transclude></div>'}}).directive("collapsibleColumn",function(){return{restrict:"EA",transclude:!0,templateUrl:"templates/collapsible-column.tpl.html",require:"?ngModel",scope:!0,link:function(a,b,c,d){a.collapsible=!1,a.defaultCollapsed=!1,a.collapsed=!1,c.$observe("collapsible",function(b){a.collapsible=angular.isDefined(b)&&"false"!==b?!0:!1}),c.$observe("defaultCollapsed",function(b){a.defaultCollapsed=angular.isDefined(b)&&"false"!==b?!0:!1,a.collapsed=a.collapsible&&a.defaultCollapsed}),d&&(d.$render=function(){var b=d.$viewValue;angular.isDefined(b)&&"false"!==b&&(a.collapsed=!0)},a.$watch("collapsed",function(a){d.$setViewValue(a)})),c.onLoad&&a.$eval(c.onLoad)}}}),angular.module("travelPlanningGame.app").directive("landmarkCard",function(){return{restrict:"EA",transclude:!0,scope:{landmark:"="},templateUrl:"templates/landmark-card.tpl.html"}}),angular.module("travelPlanningGame.maps").directive("gameMap",function(){return{templateUrl:"templates/maps.game.tpl.html",restrict:"EA",scope:{focalPoint:"=",ngModel:"=",availableLocations:"="},link:function(a,b){a.isEnabled=function(){return!b.attr("disabled")},a.showTransit=angular.isDefined(b.attr("show-transit"))&&"false"!==String(b.attr("show-transit")).toLowerCase()},controller:["$scope","$q","$filter","angulargmContainer","angulargmUtils","mapGeocoder","mapStyles","rome2rio",function(a,b,c,d,e,f,g,h){a.map={},a.map.zoom=12,a.map.type="roadmap",a.map.bounds=new google.maps.LatLngBounds,a.map.styles=g.routeXL,a.selectLocation=function(b){var c=a.ngModel;a.ngModel=b,c?h.search(c.name,b.name,h.toPosition(c.coords.lat,c.coords.lng),h.toPosition(b.coords.lat,b.coords.lng)).then(function(a){alert(a.getCost())}):alert("no cost")},a.$watch("ngModel",function(){a.$broadcast("gmMarkersUpdate")}),d.getMapPromise("gameMap").then(function(b){if(b.mapTypeId=a.map.type,b.zoom=a.map.zoom,b.setOptions({styles:a.map.styles}),a.showTransit){var c=new google.maps.TransitLayer;c.setMap(b)}angular.forEach(a.availableLocations,function(c,d){c.id=d,f.toCoords(c.address).then(function(f){c.coords=angular.copy(f),a.map.bounds.extend(e.objToLatLng(f)),d===a.availableLocations.length-1&&(b.fitBounds(a.map.bounds),a.$broadcast("gmMarkersUpdate")),a.showLabel(c,null,b)})}),a.$watch("focalPoint",function(a){a&&a.lat&&a.lng&&b.panTo(e.objToLatLng(a))})}),a.infoWindows={},a.showLabel=function(b,c,d){if(!c&&!d)return!1;var f;if(a.infoWindows[b.id])f=a.infoWindows[b.id];else{var g={};g.content='<span style="font-weight: 700">'+b.name+"</span>",g.position=e.objToLatLng(b.coords),g.pixelOffset=new google.maps.Size(0,-15),f=new google.maps.InfoWindow(g),a.infoWindows[b.id]=f}return d||(d=c.getMap()),f.open(d),!0},a.getMarkerOptions=function(b){var c={};a.ngModel&&b.id===a.ngModel.id?(c.url="../../images/marker-orange.png",c.size=new google.maps.Size(66,66),c.origin=new google.maps.Point(0,0),c.anchor=new google.maps.Point(33,33)):(c.url="../../images/marker-grey.png",c.size=new google.maps.Size(30,30),c.origin=new google.maps.Point(0,0),c.anchor=new google.maps.Point(15,15));var d={title:"Click to select "+b.name,icon:c};return d}}]}}),angular.module("travelPlanningGame.maps").directive("locationPreviewMap",function(){return{templateUrl:"templates/maps.locationpreview.tpl.html",restrict:"EA",scope:{selectedLocation:"=",availableLocations:"="},link:function(a,b){a.isEnabled=function(){return!b.attr("disabled")}},controller:["$scope","$q","angulargmContainer","angulargmUtils","mapGeocoder",function(a,b,c,d,e){a.zoom=2,a.type="roadmap",a.selectLocation=function(b){a.selectedLocation=b.id},c.getMapPromise("locationPreviewMap").then(function(b){b.mapTypeId=a.type,b.zoom=a.zoom,angular.forEach(a.availableLocations,function(c,d){c.id=d,e.toCoords(c.country+", "+c.city).then(function(e){c.coords=angular.copy(e),d===a.selectedLocation&&b.setCenter(e),a.$broadcast("gmMarkersUpdate")})})})}]}}),angular.module("travelPlanningGame.widgets").directive("widgetResourceIndicator",function(){return{restrict:"EA",templateUrl:"templates/widgets.resource-indicator.tpl.html",scope:{value:"=",role:"@"},link:function(a){a.icon="budget"===a.role?"dollar":"xp"===a.role?"star":"shopping-cart"},controller:["$scope","$filter",function(a,b){a.getValue=function(){return b("number")(a.value)}}]}}).directive("widgetDayCounter",function(){return{restrict:"EA",templateUrl:"templates/widgets.day-counter.tpl.html",scope:{value:"=",total:"="}}}),angular.module("travelPlanningGame.app").controller("EndCtrl",["$scope",function(a){a.awesomeThings=["HTML5 Boilerplate","AngularJS","Karma"]}]),angular.module("travelPlanningGame.app").controller("MainCtrl",["$scope",function(a){a.awesomeThings=["HTML5 Boilerplate","AngularJS","Karma"]}]),angular.module("travelPlanningGame.app").controller("PlayCtrl",["$scope","gameSettings","landmarks","days","bankingManager",function(a,b,c,d,e){function f(){a.settings.game=b.getSettings(),a.landmarks=c.get(),a.play.settings={},a.play.finances=e.manage("playFinances",a.settings.game.finances.budget),a.play.day=1}a.settings={},a.landmarks=[],a.play={},f(),a.canPlay=function(b){return a.selectedLandmark?a.settings.game.sandboxMode?!0:a.play.day>=a.settings.game.daysOfTravel?b?"Your trip is over.":!1:a.play.finances.getBudget()<a.selectedLandmark.visitingCost+a.selectedLandmark.lodgingCost?b?"Not enough funds for this landmark.":!1:b?"I don't know, you should be able to!":!0:b?"Select a landmark to visit.":!1},a.whyCantIPlay=function(){return a.canPlay(!0)},a.simulateDay=function(){d.newDay(a.play.day,a.play.finances).addLandmark(a.selectedLandmark).end();a.play.day++,a.selectedLandmark=null},a.skipDay=function(){d.newDay(a.play.day,a.play.finances).skip(a.play.day-1);a.play.day++}}]),angular.module("travelPlanningGame.app").controller("StartCtrl",["$scope","gameSettings",function(a,b){function c(){a.settings.game=b.getSettings()}a.settings={},c()}]),angular.module("travelPlanningGame.templates",["templates/collapsible-column.tpl.html","templates/landmark-card.tpl.html","templates/maps.game.tpl.html","templates/maps.locationpreview.tpl.html","templates/widgets.day-counter.tpl.html","templates/widgets.resource-indicator.tpl.html"]),angular.module("templates/collapsible-column.tpl.html",[]).run(["$templateCache",function(a){a.put("templates/collapsible-column.tpl.html",'<div class="collapsible-column" ng-class="{collapsed: collapsed, \'not-collapsed\': !collapsed, collapsible: collapsible}" ng-init="collapsed = true">\n	<button class="collapsible-column-toggle btn btn-default" ng-click="collapsed = !collapsed" ng-show="collapsible"><i class="icon icon-reorder"></i>\n	</button>\n	<div class="collapsible-content" ng-hide="collapsible && collapsed">\n		<div ng-transclude></div>\n	</div>\n</div>\n')}]),angular.module("templates/landmark-card.tpl.html",[]).run(["$templateCache",function(a){a.put("templates/landmark-card.tpl.html",'<!-- Landmark card -->\n<div class="landmark-card" ng-class="{flipped : isFlipped}">\n\n	<!-- Front face -->\n	<div class="panel panel-primary landmark-card-face landmark-card-face-front">\n\n		<!-- Landmark name and controls -->\n		<div class="panel-header panel-heading">\n\n			<!-- Controls -->\n			<i class="fa close fa-times fa-fw" ng-click="landmark = null"></i>\n			<i class="fa close fa-rotate-left fa-fw" ng-click="isFlipped = !isFlipped"></i>\n\n			<h3>{{ landmark.name }}</h3>\n		</div>\n		<!-- end name and controls -->\n\n		<!-- Image and quick stats -->\n		<div class="panel-body" ng-style="{\'background-image\': \'url(\' + landmark.image + \')\'}">\n			<div class="col-xs-offset-9">\n				<div class="thumbnail resource text-center">\n					<small>LODGING</small>\n					<h3>{{ landmark.lodgingCost }} <i class="fa fa-dollar"></i>\n					</h3>\n					<small>PER DAY</small>\n				</div>\n				<div class="thumbnail resource text-center">\n					<small>VISITING</small>\n					<h3>{{ landmark.visitingCost }} <i class="fa fa-dollar"></i>\n					</h3>\n					+{{ landmark.visitingExp }} <i class="fa fa-star"></i>\n				</div>\n				<div class="thumbnail resource text-center">\n					<h3>{{ landmark.souvenirs }} <i class="fa fa-shopping-cart"></i>\n					</h3>\n					<small>FOR {{ landmark.souvenirCost }} <i class="fa fa-dollar"></i>\n					</small>\n				</div>\n			</div>\n		</div>\n		<!-- end image and stats -->\n\n		<!-- Features, flavour text and options -->\n		<ul class="list-group">\n			<li class="list-group-item list-item" ng-repeat="bonus in landmark.bonuses">\n				<span class="pull-right text-primary" ng-show="bonus.type">{{ bonus.type | uppercase }}</span>\n				<i class="fa" ng-class="bonus.icon"></i> {{ bonus.flavour }}\n				<em class="text-muted" ng-show="bonus.implication">\n					<small>({{ bonus.implication }})</small>\n				</em>\n			</li>\n		</ul>\n		<!-- end features -->\n\n		<!-- One time bonus -->\n		<div class="panel-footer text-center">\n			One-time visiting bonus:\n			<strong>+{{ landmark.exp }} <i class="fa fa-star"></i>\n			</strong>\n		</div>\n		<!-- end bonus -->\n\n	</div>\n	<!-- end front face -->\n\n	<!-- Back face -->\n	<div class="panel panel-primary landmark-card-face landmark-card-face-back">\n\n		<!-- Landmark name and controls -->\n		<div class="panel-header panel-heading">\n\n			<!-- Controls -->\n			<i class="fa close fa-times fa-fw" ng-click="landmark = null"></i>\n			<i class="fa close fa-rotate-left fa-fw" ng-click="isFlipped = !isFlipped"></i>\n\n			<h3>{{ landmark.name }}</h3>\n		</div>\n		<!-- end name and controls -->\n\n		<!-- Image -->\n		<div class="panel-body" ng-style="{\'background-image\': \'url(\' + landmark.image + \')\'}">\n			<div class="col-xs-offset-9 invisible">\n				<div class="thumbnail resource text-center">\n					<small>LODGING</small>\n					<h3>{{ landmark.lodgingCost }} <i class="fa fa-dollar"></i>\n					</h3>\n					<small>PER DAY</small>\n				</div>\n				<div class="thumbnail resource text-center">\n					<small>VISITING</small>\n					<h3>{{ landmark.visitingCost }} <i class="fa fa-dollar"></i>\n					</h3>\n					+{{ landmark.visitingExp }} <i class="fa fa-star"></i>\n				</div>\n				<div class="thumbnail resource text-center">\n					<h3>{{ landmark.souvenirs }} <i class="fa fa-shopping-cart"></i>\n					</h3>\n					<small>FOR {{ landmark.souvenirCost }} <i class="fa fa-dollar"></i>\n					</small>\n				</div>\n			</div>\n		</div>\n		<!-- end image -->\n\n		<!-- Features, flavour text and options -->\n		<ul class="list-group">\n			<li class="list-group-item list-item">{{ landmark.description }}</li>\n		</ul>\n		<!-- end features -->\n\n		<!-- One time bonus -->\n		<div class="panel-footer text-center">\n			<div class="invisible">\n				One-time visiting bonus:\n				<strong>+{{ landmark.exp }} <i class="fa fa-star"></i>\n				</strong>\n			</div>\n		</div>\n		<!-- end bonus -->\n\n	</div>\n	<!-- end back face -->\n\n</div>\n<!-- end card -->\n')}]),angular.module("templates/maps.game.tpl.html",[]).run(["$templateCache",function(a){a.put("templates/maps.game.tpl.html",'<div gm-map\n	ng-if="isEnabled()"\n	class="map-canvas"\n	gm-map-id="\'gameMap\'"\n	gm-center="center"\n	gm-zoom="zoom"\n	gm-bounds="bounds"\n	gm-map-type-id="type">\n	<div gm-markers\n		gm-objects="availableLocations"\n		gm-id="object.id"\n		gm-marker-options="getMarkerOptions(object)"\n		gm-position="{lat: object.coords.lat, lng: object.coords.lng}"\n		gm-on-click="selectLocation(object, marker); showLabel(object, marker)">\n	</div>\n	<div id="map-infoWindow-markerLabel-sample">\n		<div class="well">\n			<strong>{{ location.name }}</strong>\n		</div>\n	</div>\n</div>')}]),angular.module("templates/maps.locationpreview.tpl.html",[]).run(["$templateCache",function(a){a.put("templates/maps.locationpreview.tpl.html",'<div gm-map\n	ng-if="isEnabled()"\n	class="map-canvas"\n	gm-map-id="\'locationPreviewMap\'"\n	gm-center="center"\n	gm-zoom="zoom"\n	gm-bounds="bounds"\n	gm-map-type-id="type">\n	<div gm-markers\n		gm-objects="availableLocations"\n		gm-id="object.id"\n		gm-position="{lat: object.coords.lat, lng: object.coords.lng}"\n		gm-on-click="selectLocation(object, marker)">\n	</div>\n</div>\n')}]),angular.module("templates/widgets.day-counter.tpl.html",[]).run(["$templateCache",function(a){a.put("templates/widgets.day-counter.tpl.html",'<div class="widget-day-counter">\n	<h1>Day</h1>\n	<h1>{{ ngModel | number }}<small>/ {{ total }}</h1>\n</div>\n')}]),angular.module("templates/widgets.resource-indicator.tpl.html",[]).run(["$templateCache",function(a){a.put("templates/widgets.resource-indicator.tpl.html",'<div class="widget-resource-indicator" ng-class="\'widget-resource-indicator-\' + role">\n	<i class="widget-resource-indicator-icon fa fa-fw fa-3x" ng-class="\'fa-\' + icon"></i>\n	<span class="widget-resource-indicator-value" ng-bind="getValue()"></span>\n</div>\n')}]);